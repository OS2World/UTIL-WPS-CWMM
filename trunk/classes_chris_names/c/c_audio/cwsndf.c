...
SOM_Scope PSZ  SOMLINK cwsndfM_wpclsQueryInstanceType(M_CWSNDF *somSelf)
{
    ...
    M_CWSNDFMethodDebug("M_CWSNDF","cwsndfM_wpclsQueryInstanceType");
...
{
    /* M_CWSNDFData *somThis = M_CWSNDFGetData(somSelf); */
    M_CWSNDFMethodDebug("M_CWSNDF","cwsndfM_wpclsQueryInstanceFilter");
...
{
    /* M_CWSNDFData *somThis = M_CWSNDFGetData(somSelf); */
    M_CWSNDFMethodDebug("M_CWSNDF","cwsndfM_wpclsQueryDefaultHelp");
    ...
    /*    return (M_CWSNDF_parent_M_CWAudio_wpclsQueryDefaultHelp(somSelf, 
          pHelpPanelId, 
          pszHelpLibrary));*/
}
...
SOM_Scope PSZ  SOMLINK cwsndfM_wpclsQueryTitle(M_CWSNDF *somSelf)
{
  static char chrTitle[20]={0};
    /* M_CWSNDFData *somThis = M_CWSNDFGetData(somSelf); */
    M_CWSNDFMethodDebug("M_CWSNDF","cwsndfM_wpclsQueryTitle");

    if(chrTitle[0]==0)
      if(!getMessage(chrTitle, IDSTR_SNDFTITLE, sizeof(chrTitle), queryModuleHandle(), HWND_DESKTOP))
        strcpy(chrTitle,"SNDAudio.SND");
...
{
    /* M_CWSNDFData *somThis = M_CWSNDFGetData(somSelf); */
    M_CWSNDFMethodDebug("M_CWSNDF","cwsndfM_wpclsQueryIconData");
