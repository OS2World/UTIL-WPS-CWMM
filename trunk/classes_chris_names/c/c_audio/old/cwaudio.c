...
void _Optlink playThreadFunc (void *arg)
{
  ...
  if(hab) {
    ...
    if(hmq) {
      ...
      hwnd=WinCreateWindow(HWND_OBJECT,WC_STATIC,"playObj", 0, 0, 0, 0, 0, NULLHANDLE, HWND_BOTTOM,12343,NULL,NULL);
      if(hwnd) {
                                                   ...
                                                   HWND hwndNotebook)
{
  ...
  CWAudioData *somThis = CWAudioGetData(somSelf);
    ...
    rc= (CWAudio_parent_MMAudio_wpAddSettingsPages(somSelf, 
                                                      hwndNotebook));
                                                    ...
                                                    PULONG pcp)
{
  ...
  PAUDIODETAILS pAudioDetails;
    ...
    rcParent= (CWAudio_parent_MMAudio_wpQueryDetailsData(somSelf, 
                                                      ppDetailsData, 
                                                      pcp));
                                               ...
                                               ULONG ulReserved)
{
  ...
  ULONG ulSize;
   ...
   CWAudioData *somThis = CWAudioGetData(somSelf);
    ...
    bRc=(CWAudio_parent_MMAudio_wpRestoreState(somSelf, ulReserved));
...
SOM_Scope BOOL  SOMLINK cwaudio_wpSaveState(CWAudio *somSelf)
{
    ...
    return (CWAudio_parent_MMAudio_wpSaveState(somSelf));
}
                                                  ...
                                                  ULONG iPosition)
{
    ...
    return (CWAudio_parent_MMAudio_wpModifyPopupMenu(somSelf, 
                                                     hwndMenu, 
                                                     hwndCnr, 
                                                     iPosition));
}
                                                   ...
                                                   ULONG ulMenuId)
{
    ...
    return (CWAudio_parent_MMAudio_wpMenuItemSelected(somSelf, 
                                                      hwndFrame, 
                                                      ulMenuId));
}
                                              ...
                                              ULONG ulCode, WPObject* refObject)
{
    ...
    CWAudio_parent_MMAudio_wpObjectReady(somSelf, ulCode, refObject);
}
                                          ...
                                          PVOID pReserved)
{
  ...
  bRc=(CWAudio_parent_MMAudio_wpRefresh(somSelf, ulView, 
                                        pReserved));
...
SOM_Scope BOOL  SOMLINK cwaudio_wpSetup(CWAudio *somSelf, PSZ pszSetupString)
{
  ...
  /* CWAudioData *somThis = CWAudioGetData(somSelf); */
    ...
    return (CWAudio_parent_MMAudio_wpSetup(somSelf, pszSetupString));
}
                                       ...
                                       ULONG ulView, ULONG param)
{
  ULONG ulRc;
    ...
    return (CWAudio_parent_MMAudio_wpOpen(somSelf, hwndCnr, ulView, 
                                          param));
}
                                                        ...
                                                        PULONG pSize)
{
  ...
  ULONG rc;
    ...
    cParentColumns= (M_CWAudio_parent_M_MMAudio_wpclsQueryDetailsInfo(somSelf, 
                                                             ppClassFieldInfo, 
                                                             pSize));
  if(pSize)
...
SOM_Scope void  SOMLINK cwaudioM_wpclsInitData(M_CWAudio *somSelf)
{
  ...
  USHORT i,rc;
    ...
    M_CWAudio_parent_M_MMAudio_wpclsInitData(somSelf);
...
SOM_Scope void  SOMLINK cwaudioM_wpclsUnInitData(M_CWAudio *somSelf)
{
    ...
    M_CWAudio_parent_M_MMAudio_wpclsUnInitData(somSelf);
}
