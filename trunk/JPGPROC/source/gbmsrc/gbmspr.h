...
extern GBM_ERR spr_rdata(int fd, GBM *gbm, byte *data);
extern GBM_ERR spr_w(const char *fn, int fd, const GBM *gbm, const GBMRGB *gbmrgb, const byte *data, const char *opt);
