...
/*
 * New Method: wpSetIconHandle
 */
typedef BOOL   SOMLINK somTP_WPObject_wpSetIconHandle(WPObject *somSelf, 
		HPOINTER hptrNewIcon);
#pragma linkage(somTP_WPObject_wpSetIconHandle, system)
typedef somTP_WPObject_wpSetIconHandle *somTD_WPObject_wpSetIconHandle;
#define somMD_WPObject_wpSetIconHandle "::WPObject::wpSetIconHandle"
#define WPObject_wpSetIconHandle(somSelf,hptrNewIcon) \
    (SOM_Resolve(somSelf, WPObject, wpSetIconHandle) \
	(somSelf,hptrNewIcon))
#ifndef SOMGD_wpSetIconHandle
    #if (defined(_wpSetIconHandle) || defined(__wpSetIconHandle))
        #undef _wpSetIconHandle
        #undef __wpSetIconHandle
        #define SOMGD_wpSetIconHandle 1
    #else
        #define _wpSetIconHandle WPObject_wpSetIconHandle
    #endif /* _wpSetIconHandle */
#endif /* SOMGD_wpSetIconHandle */

/*
 * New Method: wpQueryScreenGroupID
 */
typedef USHORT   SOMLINK somTP_WPObject_wpQueryScreenGroupID(WPObject *somSelf, 
		USHORT usPrevSgId);
...
#define WPObject_wpQueryScreenGroupID(somSelf,usPrevSgId) \
...
/*
 * New Method: wpSetNextObj
 */
typedef BOOL   SOMLINK somTP_WPObject_wpSetNextObj(WPObject *somSelf, 
		WPObject* pobjNext);
#pragma linkage(somTP_WPObject_wpSetNextObj, system)
typedef somTP_WPObject_wpSetNextObj *somTD_WPObject_wpSetNextObj;
#define somMD_WPObject_wpSetNextObj "::WPObject::wpSetNextObj"
#define WPObject_wpSetNextObj(somSelf,pobjNext) \
    (SOM_Resolve(somSelf, WPObject, wpSetNextObj) \
	(somSelf,pobjNext))
#ifndef SOMGD_wpSetNextObj
    #if (defined(_wpSetNextObj) || defined(__wpSetNextObj))
        #undef _wpSetNextObj
        #undef __wpSetNextObj
        #define SOMGD_wpSetNextObj 1
    #else
        #define _wpSetNextObj WPObject_wpSetNextObj
    #endif /* _wpSetNextObj */
#endif /* SOMGD_wpSetNextObj */

/*
 * New Method: wpQueryNextObj
 */
typedef WPObject*   SOMLINK somTP_WPObject_wpQueryNextObj(WPObject *somSelf);
#pragma linkage(somTP_WPObject_wpQueryNextObj, system)
typedef somTP_WPObject_wpQueryNextObj *somTD_WPObject_wpQueryNextObj;
#define somMD_WPObject_wpQueryNextObj "::WPObject::wpQueryNextObj"
#define WPObject_wpQueryNextObj(somSelf) \
    (SOM_Resolve(somSelf, WPObject, wpQueryNextObj) \
	(somSelf))
#ifndef SOMGD_wpQueryNextObj
    #if (defined(_wpQueryNextObj) || defined(__wpQueryNextObj))
        #undef _wpQueryNextObj
        #undef __wpQueryNextObj
        #define SOMGD_wpQueryNextObj 1
    #else
        #define _wpQueryNextObj WPObject_wpQueryNextObj
    #endif /* _wpQueryNextObj */
#endif /* SOMGD_wpQueryNextObj */

/*
 * New Method: wpMakeDormant
 */
typedef BOOL   SOMLINK somTP_WPObject_wpMakeDormant(WPObject *somSelf, 
		BOOL fSave);
#pragma linkage(somTP_WPObject_wpMakeDormant, system)
typedef somTP_WPObject_wpMakeDormant *somTD_WPObject_wpMakeDormant;
#define somMD_WPObject_wpMakeDormant "::WPObject::wpMakeDormant"
#define WPObject_wpMakeDormant(somSelf,fSave) \
    (SOM_Resolve(somSelf, WPObject, wpMakeDormant) \
	(somSelf,fSave))
#ifndef SOMGD_wpMakeDormant
    #if (defined(_wpMakeDormant) || defined(__wpMakeDormant))
        #undef _wpMakeDormant
        #undef __wpMakeDormant
        #define SOMGD_wpMakeDormant 1
    #else
        #define _wpMakeDormant WPObject_wpMakeDormant
    #endif /* _wpMakeDormant */
#endif /* SOMGD_wpMakeDormant */

/*
 * New Method: wpDestroyObject
 */
typedef BOOL   SOMLINK somTP_WPObject_wpDestroyObject(WPObject *somSelf);
#pragma linkage(somTP_WPObject_wpDestroyObject, system)
typedef somTP_WPObject_wpDestroyObject *somTD_WPObject_wpDestroyObject;
#define somMD_WPObject_wpDestroyObject "::WPObject::wpDestroyObject"
#define WPObject_wpDestroyObject(somSelf) \
    (SOM_Resolve(somSelf, WPObject, wpDestroyObject) \
	(somSelf))
#ifndef SOMGD_wpDestroyObject
    #if (defined(_wpDestroyObject) || defined(__wpDestroyObject))
        #undef _wpDestroyObject
        #undef __wpDestroyObject
        #define SOMGD_wpDestroyObject 1
    #else
        #define _wpDestroyObject WPObject_wpDestroyObject
    #endif /* _wpDestroyObject */
#endif /* SOMGD_wpDestroyObject */

/*
 * New Method: wpDeleteWindowPosKeys
 */
typedef BOOL   SOMLINK somTP_WPObject_wpDeleteWindowPosKeys(WPObject *somSelf);
#pragma linkage(somTP_WPObject_wpDeleteWindowPosKeys, system)
typedef somTP_WPObject_wpDeleteWindowPosKeys *somTD_WPObject_wpDeleteWindowPosKeys;
#define somMD_WPObject_wpDeleteWindowPosKeys "::WPObject::wpDeleteWindowPosKeys"
#define WPObject_wpDeleteWindowPosKeys(somSelf) \
    (SOM_Resolve(somSelf, WPObject, wpDeleteWindowPosKeys) \
	(somSelf))
#ifndef SOMGD_wpDeleteWindowPosKeys
    #if (defined(_wpDeleteWindowPosKeys) || defined(__wpDeleteWindowPosKeys))
        #undef _wpDeleteWindowPosKeys
        #undef __wpDeleteWindowPosKeys
        #define SOMGD_wpDeleteWindowPosKeys 1
    #else
        #define _wpDeleteWindowPosKeys WPObject_wpDeleteWindowPosKeys
    #endif /* _wpDeleteWindowPosKeys */
#endif /* SOMGD_wpDeleteWindowPosKeys */

/*
 * New Method: wpSetState
 */
typedef BOOL   SOMLINK somTP_WPObject_wpSetState(WPObject *somSelf, 
		ULONG fl);
#pragma linkage(somTP_WPObject_wpSetState, system)
typedef somTP_WPObject_wpSetState *somTD_WPObject_wpSetState;
#define somMD_WPObject_wpSetState "::WPObject::wpSetState"
#define WPObject_wpSetState(somSelf,fl) \
    (SOM_Resolve(somSelf, WPObject, wpSetState) \
	(somSelf,fl))
#ifndef SOMGD_wpSetState
    #if (defined(_wpSetState) || defined(__wpSetState))
        #undef _wpSetState
        #undef __wpSetState
        #define SOMGD_wpSetState 1
    #else
        #define _wpSetState WPObject_wpSetState
    #endif /* _wpSetState */
#endif /* SOMGD_wpSetState */

/*
 * New Method: wpQueryState
 */
typedef ULONG   SOMLINK somTP_WPObject_wpQueryState(WPObject *somSelf);
#pragma linkage(somTP_WPObject_wpQueryState, system)
typedef somTP_WPObject_wpQueryState *somTD_WPObject_wpQueryState;
#define somMD_WPObject_wpQueryState "::WPObject::wpQueryState"
#define WPObject_wpQueryState(somSelf) \
    (SOM_Resolve(somSelf, WPObject, wpQueryState) \
	(somSelf))
#ifndef SOMGD_wpQueryState
    #if (defined(_wpQueryState) || defined(__wpQueryState))
        #undef _wpQueryState
        #undef __wpQueryState
        #define SOMGD_wpQueryState 1
    #else
        #define _wpQueryState WPObject_wpQueryState
    #endif /* _wpQueryState */
#endif /* SOMGD_wpQueryState */

/*
 * New Method: wpModifyState
 */
typedef BOOL   SOMLINK somTP_WPObject_wpModifyState(WPObject *somSelf, 
		ULONG flFlags, 
		ULONG flMask);
#pragma linkage(somTP_WPObject_wpModifyState, system)
typedef somTP_WPObject_wpModifyState *somTD_WPObject_wpModifyState;
#define somMD_WPObject_wpModifyState "::WPObject::wpModifyState"
#define WPObject_wpModifyState(somSelf,flFlags,flMask) \
    (SOM_Resolve(somSelf, WPObject, wpModifyState) \
	(somSelf,flFlags,flMask))
#ifndef SOMGD_wpModifyState
    #if (defined(_wpModifyState) || defined(__wpModifyState))
        #undef _wpModifyState
        #undef __wpModifyState
        #define SOMGD_wpModifyState 1
    #else
        #define _wpModifyState WPObject_wpModifyState
    #endif /* _wpModifyState */
#endif /* SOMGD_wpModifyState */
...
/*
 * New Method: _get_pobjNext
 */
typedef WPObject**   SOMLINK somTP_WPObject__get_pobjNext(WPObject *somSelf);
#pragma linkage(somTP_WPObject__get_pobjNext, system)
typedef somTP_WPObject__get_pobjNext *somTD_WPObject__get_pobjNext;
/*
 * Method from the IDL attribute statement:
 * "readonly attribute WPObject** pobjNext"
 */
#define somMD_WPObject__get_pobjNext "::WPObject::_get_pobjNext"
#define WPObject__get_pobjNext(somSelf) \
    (SOM_Resolve(somSelf, WPObject, _get_pobjNext) \
	(somSelf))
#ifndef SOMGD_get_pobjNext
    #if (defined(_get_pobjNext) || defined(__get_pobjNext))
        #undef _get_pobjNext
        #undef __get_pobjNext
        #define SOMGD_get_pobjNext 1
    #else
        #define __get_pobjNext WPObject__get_pobjNext
    #endif /* __get_pobjNext */
#endif /* SOMGD_get_pobjNext */
...
/*
 * New Method: wpclsQueryMaxAnimationIcons
 */
typedef ULONG   SOMLINK somTP_M_WPObject_wpclsQueryMaxAnimationIcons(M_WPObject *somSelf);
#pragma linkage(somTP_M_WPObject_wpclsQueryMaxAnimationIcons, system)
typedef somTP_M_WPObject_wpclsQueryMaxAnimationIcons *somTD_M_WPObject_wpclsQueryMaxAnimationIcons;
#define somMD_M_WPObject_wpclsQueryMaxAnimationIcons "::M_WPObject::wpclsQueryMaxAnimationIcons"
#define M_WPObject_wpclsQueryMaxAnimationIcons(somSelf) \
    (SOM_Resolve(somSelf, M_WPObject, wpclsQueryMaxAnimationIcons) \
	(somSelf))
#ifndef SOMGD_wpclsQueryMaxAnimationIcons
    #if (defined(_wpclsQueryMaxAnimationIcons) || defined(__wpclsQueryMaxAnimationIcons))
        #undef _wpclsQueryMaxAnimationIcons
        #undef __wpclsQueryMaxAnimationIcons
        #define SOMGD_wpclsQueryMaxAnimationIcons 1
    #else
        #define _wpclsQueryMaxAnimationIcons M_WPObject_wpclsQueryMaxAnimationIcons
    #endif /* _wpclsQueryMaxAnimationIcons */
#endif /* SOMGD_wpclsQueryMaxAnimationIcons */
#ifndef SOM_DONT_USE_INHERITED_MACROS
